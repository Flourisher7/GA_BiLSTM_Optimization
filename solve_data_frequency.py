...
data_frequency_test = data_frequency.BiLSTM()
...
def mse_fitness_function(individual):
    fitness = data_frequency_test.get_mse(individual)
    return fitness
...
def main():
    ...
    print("- Best solution is: \n",
          data_frequency_test.format_params(hof.items[0]),
          "\n => Mean Squared Error = ",
